...
def read_data(file_path):
    ...
    """
    with open('D:\project\stanford-tensorflow-tutorials-master\stanford-tensorflow-tutorials-master\examples\data\corpus',mode='r',encoding='utf-8') as rf:
        words=rf.read().split()
...
def batch_gen(download_url, expected_byte, vocab_size, batch_size, 
    ...
    # utils.download_one_file(download_url, local_dest, expected_byte)###数据手工下载
